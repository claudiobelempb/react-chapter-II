...
export const ContentContainer = styled.div<IContentProps>`
  ...
  border-right: ${(props) =>
    props.isbr ? "1px solid #FFFFFF" : "1px solid none"};
  border-bottom: ${(props) =>
    props.isbb ? "1px solid #FFFFFF" : "1px solid none"};
  ...
  &::-webkit-scrollbar-thumb {
    background-color: ${(props) =>
      props.bgscroll ? props.bgscroll : props.theme.colors.dark_light};
    border-radius: 10px;
  }

  &::-webkit-scrollbar-track {
    background-color: ${(props) =>
      props.bgscroll ? props.bgscroll : props.theme.colors.light};
  }
`;
